...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            ...
            <p class="text-slate-500">Kelola semua laporan kejadian ulang</p>
        </div>
        <div class="flex flex-wrap gap-3 mt-4 md:mt-0">
            ...
            <!-- <a href="{{ route('laporan.create', ['jenis' => 'repeat']) }}"
                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-teal-600 to-teal-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-slate-100">
            <form action="{{ route('laporan.repeat.index') }}" method="GET"
                ...
                <div class="flex-1">
                    ...
                    <input type="date" name="tanggal_mulai" value="{{ request('tanggal_mulai') }}"
                        class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-teal-500 focus:bg-white transition-all">
                </div>
                <div class="flex-1">
                    <label class="block text-sm font-medium text-slate-600 mb-1.5">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('laporan.repeat.show', $laporan) }}"
                                        class="p-2 rounded-lg bg-slate-100 text-slate-600 hover:bg-teal-100 hover:text-teal-600 transition-colors"
                                        title="Detail">
