...
@section('content')
<!-- Welcome Banner -->
<div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary-600 via-primary-500 to-teal-500 p-8 mb-8 shadow-xl">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 card-hover">
        <div class="flex items-center justify-between mb-4">
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                <i class="fas fa-file-medical text-2xl text-white"></i>
            </div>
            <span class="px-3 py-1 rounded-full text-xs font-semibold bg-primary-50 text-primary-600">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="w-10 h-10 rounded-xl bg-cyan-50 flex items-center justify-center">
                <i class="fas fa-x-ray text-cyan-500"></i>
            </div>
        </div>
        <div class="h-80">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <a href="{{ route('laporan.repeat.create') }}" class="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="relative z-10 flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-blue-100">Buat laporan pemeriksaan ulang baru</p>
            </div>
        </div>
    ...
    <a href="{{ route('laporan.reject.create') }}" class="group relative overflow-hidden bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2"></div>
        <div class="relative z-10 flex items-center space-x-4">
            <div class="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <i class="fas fa-plus text-2xl text-white"></i>
            ...
            <div>
                ...
                <p class="text-red-100">Buat laporan pemeriksaan ditolak baru</p>
            </div>
        </div>
        <i class="fas fa-arrow-right absolute right-6 top-1/2 -translate-y-1/2 text-white/50 group-hover:text-white group-hover:translate-x-2 transition-all duration-300"></i>
    </a>
...
<script>
    ...
    const gradientColors = ['#10b981', '#3b82f6', '#ef4444', '#8b5cf6', '#f97316', '#06b6d4', '#ec4899', '#14b8a6'];
    ...
    new Chart(document.getElementById('chartFaktorPenyebab'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['rgba(16, 185, 129, 0.9)', 'rgba(249, 115, 22, 0.9)', 'rgba(139, 92, 246, 0.9)', 'rgba(6, 182, 212, 0.9)'],
                borderWidth: 0,
                hoverOffset: 10
            }]
        },
